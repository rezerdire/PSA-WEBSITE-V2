        ...
        <div class="grid lg:grid-cols-2 gap-10 sm:gap-16 items-center">
          <div>
            ...
            <h1 class="font-display text-3xl sm:text-5xl lg:text-6xl xl:text-6xl leading-[1.15] sm:leading-[1.08] text-slate-900 mb-4 sm:mb-6">
              PSA 58<sup class="text-2xl sm:text-3xl">th</sup> Annual <em class="text-blue-600 not-italic">Convention</em>
            </h1>

            <p class="text-slate-500 text-base sm:text-lg leading-relaxed max-w-lg mb-2">
              "Beyond the Operating Room: Innovation, Safety, Excellence"
            </p>
            <p class="text-slate-500 text-sm sm:text-base leading-relaxed max-w-lg mb-6 sm:mb-10">
              Marriott Grand Ballroom, Pasay City &middot; November 25-27, 2026
            </p>

            <div class="flex flex-wrap gap-3 sm:gap-4">
              <a href="{{ route('annual-convention-poster') }}" class="inline-flex items-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 bg-blue-600 text-white font-semibold text-sm sm:text-base rounded-xl hover:bg-blue-700 transition-all shadow-md shadow-blue-200 hover:-translate-y-0.5">
                Check the Registration Rates <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
              </a>
            </div>
          </div>
...
{{-- SLIDE 0: SIMWARS event --}}
      ...
      >
        <div class="grid lg:grid-cols-2 gap-10 sm:gap-16 items-center">
          ...
          <div class="flex justify-center lg:justify-end">
<img src="{{ asset('images/simwars-competition.png') }}" alt="Anesthesia Sim Wars Trilogy Competition, Episode 1 - Philippines Anesthesia Crisis Competition 2026" class="rounded-2xl shadow-xl shadow-blue-100 max-h-[720px] w-auto object-contain">          </div>
        </div>
      </div>
      ...
      >
        <div class="grid lg:grid-cols-2 gap-10 sm:gap-16 items-center">
          <div>
            <h1 class="font-display text-3xl sm:text-5xl lg:text-6xl xl:text-7xl leading-[1.15] sm:leading-[1.08] text-slate-900 mb-4 sm:mb-6">
            ...
            <div class="flex flex-wrap gap-3 sm:gap-4">
             <a href="{{ asset('Membership Form.pdf') }}" download class="inline-flex items-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 bg-red-600 text-white font-semibold text-sm sm:text-base rounded-xl hover:bg-red-700 transition-all shadow-md shadow-blue-200 hover:-translate-y-0.5">
            ...
            <div class="mt-10 sm:mt-14 grid grid-cols-3 gap-2 sm:gap-4 border-t border-slate-100 pt-6 sm:pt-8">
