                ...
                <form wire:submit="submit">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            <x-form.input label="PRC Number" hint="(6-7 digits)" name="prcNumber" wire:model="prcNumber" pattern="^\d{6,7}$"
                                placeholder="1234567" minlength="6" maxlength="7" inputmode="numeric"   pattern-message="PRC number must be between 6 and 7 digits."/>
